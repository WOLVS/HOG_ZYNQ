...
set id 21
set name image_filter_udiv_43ns_27ns_43_47_seq
...
set id 23
set name image_filter_udiv_27ns_27ns_27_31
...
set id 25
set name image_filter_mul_32s_12s_32_3
...
set id 27
set name image_filter_mul_28s_20s_47_3
set corename simcore_mul
set op mul
set stage_num 3
set max_latency -1
...
set id 31
set name image_filter_mul_mul_20s_8ns_28_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {20 1 +} i1 {8 0 +} p {28 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
    id ${id} \
...
set ID 35
set MemName image_filter_Resize_opr_linear_k_buf_val_val_0_0
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_cols_V_read { I 11 vector } } \
} "
}
